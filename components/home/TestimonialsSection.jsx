...
const TESTIMONIALS = [
  { quote: "legalgroup's legal team handled our corporate merger with exceptional precision. Their understanding of Indian corporate law is unmatched.", name: 'Rajesh Mehta', title: 'CEO, TechVentures India', icon: '🏢' },
