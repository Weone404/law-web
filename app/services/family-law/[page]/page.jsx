...
export function generateMetadata({ params }) {
  ...
  if (!page) return {};
  const metadata = createMetadata(`/services/family-law/${page.slug}`, { title: page.metaTitle, description: page.metaDescription });
  return {
    ...metadata,
...
export default function FamilyLawDetailPage({ params }) {
  const page = FAMILY_LAW_PAGES[params.page];
  if (!page) notFound();
  return <FamilyLawLanding page={page} basePath="/services/family-law" />;
}
